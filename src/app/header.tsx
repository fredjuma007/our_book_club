...
export async function Header() {
  ...
  return (
    <>
      {/* Fixed Header */}
      <div className="bg-gray-50 dark:bg-gray-900 border-b border-gray-300 dark:border-gray-700 fixed top-0 left-0 w-full z-50 shadow-lg backdrop-blur-md bg-opacity-90 dark:bg-opacity-80">
              ...
              {isLoggedIn ? (
                <div className="flex items-center gap-2">
                  ...
                  <form action={logoutAction}>
                    <Button variant="outline" className="border-green-600 dark:border-green-400 text-green-600 dark:text-green-400 hover:bg-green-600 hover:text-white dark:hover:bg-green-400 dark:hover:text-gray-900 transition-all">
                      Logout
                    </Button>
                  </form>
                </div>
                ...
                <form action={loginAction}>
                  <Button variant="outline" className="border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-400 dark:hover:text-gray-900 transition-all">
                    Login
                  </Button>
                </form>
              )}
