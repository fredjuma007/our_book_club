  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full z-50 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#f5f0e1]/90 dark:bg-gray-900/90 opacity-95" />
        ...
        <div className="absolute bottom-[3px] left-0 right-0 h-[1px] bg-[#fffaf0]/30 dark:bg-white/10" />
            ...
            <Button variant="link" asChild>
              <Link href="/" className="flex items-center gap-3 text-gray-900 dark:text-gray-100 group">
                <div className="relative">
                  <div className="absolute -inset-2 rounded-full bg-beige/50 dark:bg-green-900/30 opacity-70 group-hover:opacity-100 transition-opacity duration-500" />
                  <Image
                    src="/logo.jpg"
                    width={55}
                    height={55}
                    alt="TheBookClub"
                    className="rounded-full border-2 border-beige dark:border-green-800 shadow-md hover:scale-105 transition-transform duration-300 relative z-10 w-[45px] h-[45px] sm:w-[55px] sm:h-[55px]"
                  />
                  <div className="absolute -inset-1 rounded-full bg-beige/30 dark:bg-green-800/30 opacity-0 group-hover:opacity-70 transition-opacity duration-500" />
                </div>
