          ...
          <Button variant="link" asChild>
            <Link href="/" className="flex items-center gap-3 text-gray-900 dark:text-gray-100 group">
              ...
              <div className="relative overflow-hidden">
                ...
                <span
                  className="absolute inset-0 hidden md:block bg-gradient-to-r from-green-400/0 via-green-500/20 to-green-400/0 
                translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"
                />

                {/* Extra glow effect on hover */}
                <div
                  className="absolute inset-0 hidden md:block rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300
                bg-gradient-to-r from-green-400/0 via-green-500/30 to-green-400/0 blur-lg"
                ></div>
